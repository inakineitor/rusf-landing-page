        ...
        <div className="top-container">
          <div className="text-container">
            ...
            <p style={{ marginBottom: '60px' }}>
              Situated in Houston, Texas, Rice University, has historically generated the leaders of energy finance. We have a collection of experienced advisors across the entire capital stack.
            </p>
          </div>
