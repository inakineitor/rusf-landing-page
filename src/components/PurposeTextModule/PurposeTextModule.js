    ...
    <PurposeTextModuleStyles>
      <div className="container">
        ...
        <p style={{ marginBottom: '60px' }}>
          A part of the funds excess returns will be withdrawn anually for spending on sustainability initiatives at Rice, like funding unpaid internships in energy transition, installing more solar PVs on campus, and recycling (rainwater & composting).
        </p>
      </div>
    </PurposeTextModuleStyles>
  );
